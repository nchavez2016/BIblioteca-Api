...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class AutoresController : ControllerBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        [HttpGet(Name ="ObtenerAutoresV1")]//api/autor
        ...
        [ServiceFilter(typeof(HATEOASAutoresAttribute))]
                                       ...
                                       )
        {
            ...
            throw new ApplicationException("Linea que se debe borrar");
        ...
        /// <param name="autor"></param>
        /// <returns></returns>
        [HttpPost("con-fotoV1",Name ="CrearAutorConFotoV1")]        
