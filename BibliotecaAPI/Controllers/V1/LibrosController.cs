...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class LibrosController:ControllerBase
    {
        ...
        [HttpGet(Name ="ObtenerLibrosV1")] //consultar todos los libros
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [HttpGet("{id:int}",Name ="ObtenerLibroV1")]//consultar libro por id
        [AllowAnonymous] //permite que un usuaruo no logeado use el metodo de API
        [OutputCache(Tags = [cache])] //para guardar en cache [depende de configuracion en program.cs]
        ...
        /// < returns ></ returns >
        [HttpPost(Name ="CrearLibroV1")]//crear un libro
        ...
        [HttpPut("{id:int}",Name ="ActualizarLibroV1")] //actualizar
